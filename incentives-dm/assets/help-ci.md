...
The following figure describes how an interval plot should be interpreted.

<img style="" src="./incentives-dm/assets/img/tutorial/05-help-ci.png" alt="dist-explanation" width="80%"/><br/>
