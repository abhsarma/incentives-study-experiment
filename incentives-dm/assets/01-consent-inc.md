...
### Title of Research Study: Improving Evaluation of Decision-making Quality in Visual Analytics

**Principal Investigator**: Abhraneel Sarma

**Co-Principal Investigator**: Prof. Alexander Lex
...
You will be presented with a tutorial of a visualization. You will then complete four training tasks. Following the training you will be presented with the details of the experimental task, and complete 18 trials.

**Will being in this study help me in any way?**
We cannot promise any benefits to you or others from your taking part in this research.

**Is there any way being in this study could be bad for me?**
A potential risk of participation is that confidentiality could be compromised. We do not ask for any additional personal information besides the demographics information shared by Prolific. However, people outside the study might get hold of confidential study information such as your Prolific ID and other demographic information.  We will do everything we can to minimize this risk, as described in more detail later in this form.

**What happens if I do not want to be in this research, or I change my mind later?**
Participation in research is voluntary. You can decide to participate or not to participate.  If you do not want to be in this study or withdraw from the study at any point and it will not be held against you. If you decide to withdraw from this study, any data already collected from you will be destroyed. Moreover, you may not be compensated for your partial participation.
...
You will receive a guaranteed $1.25 for your participation in this study. In addition, based on your responses to the survey questions, you may receive a bonus of up to $6 (average bonus will be approximately $1.5).
...
In accordance with the EU Regulation 2016/679 (General Data Protection Regulation), we would like to ensure transparency regarding handling your personal information. Graz University of Technology serves as the data controller, processing data in compliance with the GDPR. We collect demographics, and behavioral data based on explicit consent. Data is collected via Prolific; researchers access only pseudonymized IDs, not direct PII (names/emails). Upon completion of compensation, Prolific IDs are removed to create a fully anonymized dataset for analysis. Data is stored on secure university servers with access restricted to the research team. Participants retain the right to withdraw consent and request data erasure (Article 17) at any time prior to final anonymization by contacting Abhraneel Sarma (asarma@tugraz.at)
