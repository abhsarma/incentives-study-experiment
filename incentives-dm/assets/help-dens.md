...
The following figure describes how a density plot should be interpreted.

<img style="" src="./incentives-dm/assets/img/tutorial/05-help-dens.png" alt="dist-explanation" width="80%"/><br/>
